      ...
      <section className="grid gap-4 md:grid-cols-3">
        <div className="stat-card accent-emerald min-h-[128px]">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-slate-500">Total requirements</p>
              <p className="mt-2 text-3xl font-black text-slate-950">{rows.length}</p>
              <p className="mt-1 text-sm text-slate-600">Active compliance items</p>
            </div>
          </div>
        </div>

        <div className="stat-card accent-red min-h-[128px]">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-slate-500">Overdue / At-risk</p>
              <p className="mt-2 text-3xl font-black text-slate-950">{overdueCount}</p>
              <p className="mt-1 text-sm text-slate-600">Items overdue or past due date</p>
            </div>
          </div>
        </div>

        <div className="stat-card accent-amber min-h-[128px]">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-slate-500">Pending / Upcoming</p>
              <p className="mt-2 text-3xl font-black text-slate-950">{pendingCount}</p>
              <p className="mt-1 text-sm text-slate-600">Items pending or upcoming</p>
            </div>
          </div>
        </div>
      </section>
