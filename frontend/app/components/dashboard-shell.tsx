...
const NAV_ICONS: Record<string, string> = {
  ...
  "/data-health": "M3.75 4.5A1.5 1.5 0 0 1 5.25 3h13.5A1.5 1.5 0 0 1 20.25 4.5v10.5a1.5 1.5 0 0 1-1.5 1.5H13.5l-3.75 3v-3H5.25a1.5 1.5 0 0 1-1.5-1.5V4.5Zm4.5 2.25a.75.75 0 0 0 0 1.5h8.25a.75.75 0 0 0 0-1.5H8.25Zm0 3a.75.75 0 0 0 0 1.5h5.25a.75.75 0 0 0 0-1.5H8.25Zm0 3a.75.75 0 0 0 0 1.5h3a.75.75 0 0 0 0-1.5h-3Z", 
...
const managementNavigation: NavItem[] = [
  ...
  { href: "/data-health", label: "Data Health", icon: <NavIcon path={NAV_ICONS["/data-health"]} /> },
