      ...
      <div className="w-full max-w-md">
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-2xl shadow-blue-600/10">
          <div className="text-center">
            ...
            <h1 className="mt-2 text-2xl font-black tracking-tight text-slate-900">Signing you in...</h1>
            <p className="mt-2 text-sm text-slate-600">Preparing your HR workspace and redirecting you now.</p>
            <div className="mt-8">
